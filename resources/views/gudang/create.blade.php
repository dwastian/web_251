    ...
    <form id="gudang-form">
            ...
            <div class="card-body">
                <div class="row g-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" name="kodegudang" class="form-control" placeholder="Contoh: GD001" required>
                        <div class="invalid-feedback" id="error-kodegudang"></div>
                    </div>

                    <div class="col-md-6">
                        <label class="form-label">Nama Gudang</label>
                        <input type="text" name="namagudang" class="form-control" placeholder="Nama Gudang" required>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="kontak" class="form-control" placeholder="Nomor Telepon/PIC" required>
                        <div class="invalid-feedback" id="error-kontak"></div>
                    </div>

                    <div class="col-md-6">
                        <label class="form-label">Kapasitas</label>
                        <input type="number" name="kapasitas" class="form-control" placeholder="Kapasitas Gudang" required>
        ...
        <div class="d-flex justify-content-center mt-4">
            <button type="submit" id="btn-save" class="btn btn-primary btn-lg px-5">
                <i class="fa fa-save me-2"></i> Simpan Gudang
            </button>
        </div>
    </form>
